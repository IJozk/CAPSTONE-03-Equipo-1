    ...
    <div class="flex items-center space-x-4">
      ...
      <div>
        ...
        <nav class="flex items-center space-x-1 text-xs text-gray-500">
          <router-link to="/admin/dashboard" class="hover:text-primary-600 transition-colors">
            Admin
          </router-link>
...
const userEmail = computed(() => authStore.userEmail || 'admin@dataschool.com');
...
const recentAlerts = computed(() => adminStore.systemAlerts.slice(0, 5));
...
const pageTitles: Record<string, string> = {
  ...
  '/admin/calendar': 'Calendario Académico',
  ...
  '/admin/analytics': 'Dashboards Analíticos',
...
const pageTitle = computed(() => {
  return pageTitles[route.path] || 'Panel de Administración';
});
